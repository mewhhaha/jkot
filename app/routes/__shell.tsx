...
const calcTimeOfDay = (): TimeOfDay => {
  const hours = new Date().getHours();
  if (hours >= 21) return TimeOfDay.Night;
  if (hours >= 15) return TimeOfDay.Evening;
  if (hours >= 11) return TimeOfDay.Midday;
  if (hours >= 3) return TimeOfDay.Morning;
